...
public class Recipes
{
    public static void init() {
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.SteelBlock), "vvv", "vvv", "vvv", 'v', ModItems.Steel));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModItems.Steel, 9), new ItemStack(ModBlocks.SteelBlock)));
	}
}